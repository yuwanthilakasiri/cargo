...
class ClientController extends Controller
{
    ...
    public function registerStore(Request $request , $calc = false)
    {
        ...
        $request->validate([
            ...
            'nic_number_italian'   => 'required',
            'passportno'   => 'required',
            'branch_id' => 'required',
            'terms_conditions' => 'required',
        ]);

        $data = $request->only(['last_name','first_name', 'email', 'password', 'responsible_mobile', 'country_code' , 'responsible_name','national_id','branch_id']);
    ...
    public function addNewAddress(Request  $request , $calc = false , $return_view = false)
    {
        ...
        $client_address->postal_code                  = $request->postal_code;
