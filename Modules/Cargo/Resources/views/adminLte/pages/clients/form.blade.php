...
<div class="row mb-6">
    ...
    <!--begin::Label-->
    <label class="col-form-label fw-bold fs-6 required">{{ __('cargo::view.table.last_name') }}</label>
    <!--end::Label-->
    <!--begin::Input group-->
    
        <div class="input-group mb-4">
            <input type="text" name="last_name" class="form-control form-control-lg @error('last_name') is-invalid @enderror" placeholder="{{ __('cargo::view.table.last_name') }}" value="{{ old('last_name', isset($model) ? $model->last_name : '') }}" />
            @error('last_name')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
    ...
    <div class="col-lg-6 fv-row">
        <label class="col-form-label fw-bold fs-6 required">{{ __('cargo::view.table.first_name') }}</label>
    <!--end::Label-->
    <!--begin::Input group-->
    
        <div class="input-group mb-4">
            <input type="text" name="first_name" class="form-control form-control-lg @error('first_name') is-invalid @enderror" placeholder="{{ __('cargo::view.table.first_name') }}" value="{{ old('first_name', isset($model) ? $model->first_name : '') }}" />
            @error('first_name')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
...
<div class="row mb-6">
    <div class="col-lg-6 fv-row">
    <!--begin::Label-->
    <label class="col-form-label fw-bold fs-6 required">{{ __('cargo::view.table.nic_number_italian') }}</label>
    <!--end::Label-->
    <!--begin::Input group-->
    
        <div class="input-group mb-4">
            <input type="text" name="nic_number_italian" class="form-control form-control-lg @error('nic_number_italian') is-invalid @enderror" placeholder="{{ __('cargo::view.table.nic_number_italian') }}" value="{{ old('nicitaly', isset($model) ? $model->nic_number_italian : '') }}" />
            @error('nic_number_italian')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            @enderror
    ...
    <div class="col-lg-6 fv-row">
        <label class="col-form-label fw-bold fs-6 ">{{ __('cargo::view.table.nic_number_srilankan') }}</label>
    <!--end::Label-->
    <!--begin::Input group-->
    
        <div class="input-group mb-4">
            <input type="text" name="niclk" class="form-control form-control-lg @error('niclk') is-invalid @enderror" placeholder="{{ __('cargo::view.table.nic_number_srilankan') }}" value="{{ old('niclk', isset($model) ? $model->niclk : '') }}" />
            @error('niclk')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
...
<div class="row mb-6">
    <div class="col-lg-6 fv-row">
    <!--begin::Label-->
    <label class="col-form-label fw-bold fs-6 required">{{ __('cargo::view.table.passport_no') }}</label>
    <!--end::Label-->
    <!--begin::Input group-->
    
        <div class="input-group mb-4">
            <input type="text" name="passportno" class="form-control form-control-lg @error('passportno') is-invalid @enderror" placeholder="{{ __('cargo::view.table.passport_no') }}" value="{{ old('passportno', isset($model) ? $model->passportno : '') }}" />
            @error('passportno')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
    ...
    <div class="col-lg-6 fv-row">
        <label class="col-form-label fw-bold fs-6 required">{{ __('cargo::view.table.fiscal_code') }}</label>
    <!--end::Label-->
    <!--begin::Input group-->
    
        <div class="input-group mb-4">
            <input type="text" name="fiscalcode" class="form-control form-control-lg @error('fiscal_code') is-invalid @enderror" placeholder="{{ __('cargo::view.table.fiscal_code') }}" value="{{ old('fiscalcode', isset($model) ? $model->fiscalcode : '') }}" />
            @error('fiscalcode')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div data-repeater-item class="data-repeater-item-count">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="col-lg-6 fv-row">
        <!--begin::Label-->
                        <label class="col-form-label fw-bold fs-6 required">{{ __('cargo::view.table.postal_code') }}</label>
        <!--end::Label-->
                        <div class="input-group mb-4">
                            <input type="text" name="postal_code" class="form-control  @error('postal_code') is-invalid @enderror" placeholder="{{ __('cargo::view.table.postal_code') }}" value="{{ old('postal_code', isset($model) ? $model->postal_code : '') }}" />
                            @error('postal_code')
                            <div class="invalid-feedback">
                              {{ $message }}
                             </div>
